...
public class ContactActivity  extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) { //đọc vị trí gg map
        LatLng latLng = new LatLng(9.346548,106.107180); // vĩ độ trên ggmaps
        MarkerOptions options = new MarkerOptions();
        options.position(latLng);
        options.title("Sóc Trăng");
        options.snippet("Sóc trăng là một tỉnh thuộc Việt Nam"); // option hiển thị thông tin vị trí lấy từ gg map
